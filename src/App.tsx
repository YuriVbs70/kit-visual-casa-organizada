...
function CtaButton({ onClick, label = 'Quero conhecer o kit' }: { onClick: () => void; label?: string }) {
  return <button onClick={onClick} className="group inline-flex items-center justify-center gap-2 rounded-xl bg-[#D9796B] px-7 py-4 text-sm font-extrabold uppercase tracking-wide text-white shadow-[0_10px_30px_rgba(217,121,107,.24)] transition hover:bg-[#C96659] active:scale-[.98]">{label}<ArrowRight className="h-5 w-5 transition group-hover:translate-x-1" /></button>;
}
